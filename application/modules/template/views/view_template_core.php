                ...
                <div class="app-header__menu">
                    ...
                    <div class="app-sidebar__inner">
                        <ul class="vertical-nav-menu">
                            ...
                            <li class="app-sidebar__heading">Mengajari</li>
                            <?php if ($menu=="hasan_tok"){?><li class="mm-active"><?php }else{?><li><?php }?>
                                       <a href="<?php echo base_url('hasan_tok'); ?>">
                                           <i class="metismenu-icon pe-7s-rocket"></i>Hasan bau kencur
                                        </a>
                                    </li>
                            
                            <?php if ($menu=="dhinda_unch"){?><li class="mm-active"><?php }else{?><li><?php }?>
                                       <a href="<?php echo base_url('dhinda_unch'); ?>">
                                           <i class="metismenu-icon pe-7s-airplay"></i>Dhinda
                                        </a>
                                    </li>
                            
                            <li class="app-sidebar__heading">Sedang Belajar....</li>
                            <?php if ($menu=="belajar"){?><li class="mm-active"><?php }else{?><li><?php }?>
                                       <a href="<?php echo base_url('belajar'); ?>">
                                           <i class="metismenu-icon pe-7s-airplay"></i>Belajar
                                        </a>
                                    </li>
                        </ul>
                    </div>
